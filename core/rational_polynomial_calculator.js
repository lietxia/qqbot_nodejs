/**
 * @模块 rational_polynomial_calculator.js
 * @描述 有理数域上的多项式运算模块，提供多项式加减乘除、GCD和求逆
 */
...
/**
 * @模块 rational_polynomial_calculator.js
 * @描述 有理数系数多项式运算模块，支持多项式加减乘除、最大公因式、模逆元等运算
 */

/**
 * 多项式数乘
 * @param {Array<Array<string>>} pol_a - 多项式系数数组（有理数表示）
 * @param {Array<string>} rat_b - 有理数乘数
 * @returns {Array<Array<string>>} - 数乘后的多项式
 */
 ...
 * 多项式数除
 * @param {Array<Array<string>>} pol_a - 多项式系数数组（有理数表示）
 * @param {Array<string>} rat_b - 有理数除数
 * @returns {Array<Array<string>>} - 数除后的多项式
 */
...
/**
 * 多项式首一化（将首项系数化为1）
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @returns {Array<Array<string>>} - 首一化后的多项式
 */
 ...
 * 多项式化简（去除前导零系数）
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @returns {Array<Array<string>>} - 化简后的多项式
 */
 ...
 * 多项式系数反转
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @returns {Array<Array<string>>} - 反转后的多项式
 */
 ...
 * 判断两个多项式是否相等
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @param {Array<Array<string>>} pol_b - 多项式系数数组
 * @returns {boolean} - 是否相等
 */
 ...
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @param {Array<Array<string>>} pol_b - 多项式系数数组
 * @returns {Array<Array<string>>} - 差多项式
 */
 ...
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @param {Array<Array<string>>} pol_b - 多项式系数数组
 * @returns {Array<Array<string>>} - 积多项式
 */
...
/**
 * 多项式带余除法
 * @param {Array<Array<string>>} pol_a - 被除多项式
 * @param {Array<Array<string>>} pol_b - 除数多项式
 * @returns {Array<Array<Array<string>>>} - [商多项式, 余数多项式]
 */
...
/**
 * 深拷贝多项式
 * @param {Array} pol - 有理数系数多项式
 * @returns {Array} 拷贝的多项式
 */
/**
 * 多项式深拷贝
 * @param {Array<Array<string>>} pol - 多项式系数数组
 * @returns {Array<Array<string>>} - 拷贝后的多项式
 */
 ...
 * @param {Array} pol_a - 有理数系数多项式
 * @param {Array} pol_b - 有理数系数多项式
 * @returns {Array} [系数1, 系数2]，使得系数1*pol_a + 系数2*pol_b = gcd
 */
/**
 * 多项式扩展欧几里得算法，求最大公因式的线性表示
 * @param {Array<Array<string>>} pol_a - 多项式系数数组
 * @param {Array<Array<string>>} pol_b - 多项式系数数组
 * @returns {Array<Array<Array<string>>>} - [系数u, 系数v]，使得u*pol_a + v*pol_b = gcd
 */
...
/**
 * 多项式模逆元（在不可约多项式下的逆元）
 * @param {Array<Array<string>>} pol_irr - 不可约多项式
 * @param {Array<Array<string>>} pol_a - 待求逆的多项式
 * @returns {Array<Array<string>>} - 逆元多项式
 */
