/**
 * @模块 algebraic_calculator.js
 * @描述 代数数运算模块，支持单扩张代数数域上的加减乘除、幂运算和显示
 */
...
/**
 * 将字符串定义的数转换为代数数对象
 * @param {string} order_string - 输入的数字字符串
 * @returns {Object} 代数数对象 {base, coefficient}
 */
...
/**
 * 化简代数数，对系数多项式取模最小首一多项式
 * @param {Object} alg_a - 代数数对象
 * @returns {Object} 化简后的代数数对象
 */
...
/**
 * 代数数的代数数次幂
 * @param {Object} alg_a - 底数代数数对象
 * @param {Object} alg_b - 指数代数数对象
 * @returns {Object} 幂运算结果代数数对象
 */
 ...
 * 代数数加法
 * @param {Object} alg_a - 代数数对象
 * @param {Object} alg_b - 代数数对象
 * @returns {Object} 和的代数数对象
 */
