/**
 * @模块 tenhou.js
 * @描述 天凤麻将和牌判定与向听数计算核心算法（源自天凤C-EGG），包含MPSZ牌面转换、AGARIPATTERN和牌模式、AGARI和牌判定、SYANTEN向听数计算
 */
...
/** @type {Object} 牌面字符串转换工具集 */
var MPSZ = {
    aka: true,
    fromHai136: function (hai136) {
        var a = (hai136 >> 2);
        if (!this.aka) return ((a % 9) + 1) + "mpsz".slice(a / 9, a / 9 + 1);
        return (a < 27 && (hai136 % 36) == 16 ? "0" : ((a % 9) + 1)) + "mpsz".slice(a / 9, a / 9 + 1);
    },
    expand: function (t) {
        return t
