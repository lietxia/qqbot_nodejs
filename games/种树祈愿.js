/**
 * @模块 种树祈愿.js
 * @描述 种树祈愿游戏模块，包含抽奖、升级等机制
 */

/** @type {object} 玩家种树祈愿数据字典 */
tree_prize_record_dict = {};

/** @type {object} 树苗升级品种列表 */
tree_upgrade_variety_list = { "树苗": ["三叶苗", "莲子苗", "松子苗"], "三叶苗": ["新草苗", "长草苗"], "莲子苗": [""] }

/**
 * 创建玩家种树祈愿记录
 * @param {string} id - 玩家QQ号
...
/**
 * 检查三个奖品是否匹配
 * @param {number} a - 第一个奖品
 * @param {number} b - 第二个奖品
 * @param {number} c - 第三个奖品
 * @returns {number} 匹配结果值
 */
