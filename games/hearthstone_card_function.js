/**
 * @模块 hearthstone_card_function.js
 * @描述 炉石传说卡牌查询与格式化函数，包括卡牌搜索、绰号匹配、职业/类型/稀有度转换
 */

/**
 * 查询炉石卡牌信息并格式化输出
 * @param {string} name - 卡牌名称或关键词
 * @param {boolean} nocardmark - 是否显示"没有找到"提示，递归调用时为false
 * @returns {string} 格式化的卡牌信息字符串
 */
...
/**
 * 添加炉石卡牌绰号
 * @param {string} name - 卡牌正式名称
 * @param {string} nickname - 绰号
...
/**
 * 将卡牌类型ID转换为中文名称
 * @param {number} id - 卡牌类型ID
 * @returns {string} 卡牌类型中文名称
 */
